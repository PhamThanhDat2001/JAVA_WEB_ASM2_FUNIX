        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form:form modelAttribute="company" action="${pageContext.request.contextPath}/updateCompanyInfo" method="post" class="company-form">
                         <!-- Hidden input field for 'id' -->
                            <form:hidden path="id" />
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <form:input path="nameCompany" class="form-control"/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="phoneNumber">Số điện thoại công ty:</label>
                            <form:input path="phoneNumber" class="form-control"/>
                        </div>
                        <div class="form-group">
