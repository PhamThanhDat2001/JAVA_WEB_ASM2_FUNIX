...
<header class="header-container">
    ...
    <div class="header-content">
        <a href="/asm2/home" style="color:white;"> Trang chủ </a> / <br> <h4> Danh sách tìm kiếm </h4>
    </div>
        ...
        <div class="related-jobs">
            <c:forEach var="job" items="${jobs}">
                <div class="related-job-item">
                    <p style="color:blue;">${job.type}</p>
                    <h4>Tuyển ${job.title}</h4>
                    <div style="display:flex">
                        <p><i class="bi bi-stack"></i>${job.company.nameCompany}</p>
...
<button class="btn btn-primary" onclick="redirectToDetails(${job.id})">Chi tiết</button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="applyModalLabel">${job.title}</h5>
            ...
            <input type="hidden" id="recruitmentId" name="recruitmentId" value="${job.id}">
